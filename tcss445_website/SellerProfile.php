...
<!--  ************************** -->
          <li role="presentation" class="active"><a href="SellerProfile.php">Profile</a></li>
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <h3>Username: <?php echo $username; ?></h3>
		        ...
		        Update Preferred Name: <input type="text" class="form-control" value="<?php echo $name; ?>" placeholder="enter preferred name" name="pref_name" autofocus /><br />
		        Update Email Address: <input type="email" class="form-control" value="<?php echo $email; ?>" placeholder="enter email" name="email"/>
